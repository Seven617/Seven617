...
/**
 * Created by daichen on 2017/11/7.
 */
...
public class DateUtil {
     ...
     * @return 日期字符串
     */
    public static String TimestampToString(long timestamp, DateStyle dateStyle) {
        return DateToString(new Date((timestamp * 1000l)), dateStyle);
    }
     ...
     * 日期转时间戳
     */
    public static Long getTimeStr(String time){
    ...
    public static String getLastDayOfMonth(String date) {
        String nextMonth = addMonth(date, 1);
        String lastdayOfMonth = addDay(nextMonth, -1);
